...
const FloatingAiAssistant = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button 
        className={`relative w-16 h-16 rounded-full flex items-center justify-center transition-all duration-500 transform bg-medifly-teal ${
          isChatOpen ? 'rotate-90 chat-open' : 'rotate-0'
        }`}
      ...
      >
        ...
        {/* Glowing animation - only when chat is closed */}
        {!isChatOpen && (
      ...
      {isChatOpen && (
        ...
        >
          <div className="relative flex flex-col rounded-3xl bg-white border border-zinc-500/50 shadow-2xl backdrop-blur-3xl overflow-hidden">
            
            {/* Header */}
            <div className="flex items-center justify-between px-6 pt-4 pb-2">
              <div className="flex items-center gap-1.5">
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                <span className="text-xs font-medium text-zinc-400">Aira</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="px-2 py-1 text-xs font-medium bg-zinc-800/60 text-white rounded-2xl">
                  GPT-4
                </span>
                <span className="px-2 py-1 text-xs font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-2xl">
                  Pro
                </span>
                <button 
            ...
            <div className="relative overflow-hidden">
              <textarea
                ...
                rows={4}
                className="w-full px-6 py-4 bg-transparent border-none outline-none resize-none text-base font-normal leading-relaxed min-h-[120px] placeholder-zinc-500 scrollbar-none"
                placeholder="Hi — I'm Aira, your AI Medical Concierge. I'm here to help you find hospitals, doctors, or services. Tell me a bit about your needs or location and I'll guide you warmly."
            ...
            <div className="px-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {/* Attachment Group */}
                  <div className="flex items-center gap-1.5 p-1 bg-white rounded-xl border ">
                    {/* File Upload */}
                  ...
                  {/* Voice Button */}
                  <button className="group relative p-2.5 bg-transparent border border-zinc-700/20 rounded-lg cursor-pointer transition-all duration-300 text-zinc-500 hover:text-red-400 hover:bg-zinc-800/80 hover:scale-110 hover:rotate-2 transform hover:border-red-500/30">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    onClick={handleSend}
                    className="group relative p-3 bg-medifly-teal border-none rounded-xl cursor-pointer transition-all duration-300 text-white shadow-lg hover:from-red-500 hover:to-red-400 hover:scale-110 hover:shadow-red-500/30 hover:shadow-xl active:scale-95 transform hover:-rotate-2 hover:animate-pulse"
                    style={{
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-zinc-800/50 text-xs text-zinc-500 gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Press <kbd className="px-1.5 py-1 bg-medifly-teal border border-white rounded text-white font-mono text-xs shadow-sm">Shift + Enter</kbd> for new line
                  </span>
                </div>
      ...
      <style jsx>{`
        ...
        .floating-ai-button:hover:not(.chat-open) {
          transform: scale(1.1) rotate(5deg);
          box-shadow: 0 0 30px rgba(139, 92, 246, 0.9), 0 0 50px rgba(124, 58, 237, 0.7), 0 0 70px rgba(109, 40, 217, 0.5);
        }
        
        .floating-ai-button.chat-open:hover {
          transform: scale(1.05) rotate(90deg);
          box-shadow: 0 0 15px rgba(139, 92, 246, 0.5), 0 0 25px rgba(124, 58, 237, 0.3);
        }
      `}</style>
    </div>
  );
